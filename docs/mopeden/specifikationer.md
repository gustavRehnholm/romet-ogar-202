...
Tekniska specifikationer för **Romet Ogar 202, årsmodell 2022**.
...
| Modell                      | Ogar 202                                                 |
| Årsmodell                   | 2022                                                     |
| Fordonstyp                  | Moped klass I                                            |
| Fordonskategori             | L1e-B                                                    |
| Tillverkare                 | Chongqing Yingang Science & Technology (Group) Co., Ltd. |
| Avgasklass                  | Euro 5                                                   |
...
| Egenskap       | Specifikation                        |
| -------------- | ------------------------------------ |
| Motortyp       | 1-cylindrig fyrtakts bensinmotor     |
| Cylindervolym  | 48 cm³                               |
| Kylning        | Luftkyld                             |
| Effekt         | 2,2 kW                               |
| Max vridmoment | 2 Nm                                 |
| Bränslesystem  | Elektronisk bränsleinsprutning (EFI) |
...
| Egenskap      | Fram               | Bak                |
| ------------- | ------------------ | ------------------ |
| Fälg          | 17 × 1.20          | 17 × 1.40          |
| Däckdimension | 2.25-17            | 2.75-17            |
| Broms         | Mekanisk trumbroms | Mekanisk trumbroms |
...
| -------------- | ----------------------------------- |
| Systemspänning | 12 V                                |
| Tändning       | ECU-styrd elektronisk tändning      |
| Batteri        | 12N5-3B, 12 V 5 Ah                  |
...
Det dokumenterade exemplarets VIN börjar med `LY4`. Det fullständiga ramnumret publiceras inte.
